...
$lang['achieve']			= "Haut Fait";
$lang['asc']				= "Ascendant";
$lang['boton']				= "Le Bot est en marche...";
$lang['botoff']				= "Le Bot est arrêté.";
...
$lang['clean']				= "Scan des clients, certains doivent être supprimés...";
$lang['cleanc']				= "Clients propres";
$lang['cleancdesc']			= "Avec cette fonction, les anciens clients dans le ranksystem sont supprimés.<br><br>A la fin, le Ranksystem se synchronise avec la base de donnée du TeamSpeak. Les clients, qui n'existe pas ou plus dans le serveur TeamSpeak, seront alors supprimés du Ranksystem.<br><br>Cette fonction est uniquement active lorsque le 'Query-Slowmode' est désactivée !<br><br><br>Pour un ajustement automatique de la base de données le 'ClientCleaner' peut être utilisé:<br>%s";
...
$lang['cleants']			= "Clients trouvés dans la base de donnée du TeamSpeak: %s (De %s)";
